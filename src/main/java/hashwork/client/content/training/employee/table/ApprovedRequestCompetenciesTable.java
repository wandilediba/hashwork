 ...
 */
public class ApprovedRequestCompetenciesTable extends Table {
    private final MainLayout main;

    public ApprovedRequestCompetenciesTable(final MainLayout main) {
        this.main = main;
        setSizeFull();
        ...
        Set<CompetencyRequestAggregate> requests = TrainingFacade.competencyRequestAggregateService.getApprovedRequests();
