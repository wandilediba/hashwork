...
import hashwork.client.content.system.utilities.model.StatusModel;
...
public class StatusForm extends FormLayout {
    ...
    public StatusForm() {
        ...
        TextField statusType = UIComponent.getTextField("Status Type :", "statusType", StatusModel.class, binder);
        TextField statusValues = UIComponent.getTextField("Status Value :", "statusValues", StatusModel.class, binder);
