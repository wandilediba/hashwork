...
public class PositionTypeForm extends FormLayout {
    private final PositionTypeModel bean;
    public final BeanItem<PositionTypeModel> item;
    ...
    public PositionTypeForm() {
        bean = new PositionTypeModel();
        item = new BeanItem<>(bean);
        binder = new FieldGroup(item);

        final UIComponentHelper UIComponent = new UIComponentHelper();

        TextField name = UIComponent.getTextField("Position Type :", "name", PositionTypeModel.class, binder);
        addComponent(name);
